...
// --------------------------------
	...
	//Slide Button 1
	wp.customize( 'complete[slide_btn1]', function( value ) { value.bind( function( newval ) {   $( '.slidebtn a' ).html( newval );  } );  } );
	
	//Slide Button 2
	wp.customize( 'complete[slide_btn2]', function( value ) { value.bind( function( newval ) {   $( '.slidebtn a' ).html( newval );  } );  } );	
	
	//Slide Button 3
	wp.customize( 'complete[slide_btn3]', function( value ) { value.bind( function( newval ) {   $( '.slidebtn a' ).html( newval );  } );  } );	
	
	//Slide Button 4
	wp.customize( 'complete[slide_btn4]', function( value ) { value.bind( function( newval ) {   $( '.slidebtn a' ).html( newval );  } );  } );
	
	//Slide Button 5
	wp.customize( 'complete[slide_btn5]', function( value ) { value.bind( function( newval ) {   $( '.slidebtn a' ).html( newval );  } );  } );
	
	//Slide Button 6
	wp.customize( 'complete[slide_btn6]', function( value ) { value.bind( function( newval ) {   $( '.slidebtn a' ).html( newval );  } );  } );	
	
	//Slide Button 7
	wp.customize( 'complete[slide_btn7]', function( value ) { value.bind( function( newval ) {   $( '.slidebtn a' ).html( newval );  } );  } );
	
	//Slide Button 8
	wp.customize( 'complete[slide_btn8]', function( value ) { value.bind( function( newval ) {   $( '.slidebtn a' ).html( newval );  } );  } );	
	
	//Slide Button 9
	wp.customize( 'complete[slide_btn9]', function( value ) { value.bind( function( newval ) {   $( '.slidebtn a' ).html( newval );  } );  } );
	
	//Slide Button 10
	wp.customize( 'complete[slide_btn10]', function( value ) { value.bind( function( newval ) {   $( '.slidebtn a' ).html( newval );  } );  } );	
